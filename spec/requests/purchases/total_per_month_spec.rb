  ...
  describe 'GET index' do
    context 'no params' do
      it 'returns totals of purchases purchased this month' do
        ...
        first_price = 12.50
        second_price = 12.75
        create(:purchase, user: user, name: name, price: first_price)
        create(:purchase, user: user, name: name, price: second_price)
        create(:purchase, user: user, name: name, price: second_price, purchase_date: 2.months.ago)
    ...
    context 'month and year param' do
      it 'returns totals of purchases purchased in given month' do
        ...
        create(:purchase, user: user, name: name, price: first_price)
        create(:purchase, user: user, name: name, price: second_price)
        create(:purchase, user: user, name: name, price: second_price, purchase_date: Date.parse('12/12/2012'))
